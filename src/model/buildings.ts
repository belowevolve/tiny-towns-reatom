...
export const BUILDINGS: Record<BuildingType, BuildingDef> = {
  ...
  bank: {
    description:
      "4 VP. При постройке — положить уникальный ресурс. Как главный строитель вы больше не можете использовать этот ресурс",
    hooks: {
  ...
  factory: {
    description:
      "При постройке — положить уникальный ресурс. Когда другой игрок объявляет его, вы можете разместить на планшете ресурс другого типа вместо объявленного",
    hooks: {
  ...
  warehouse: {
    description:
      "-1 VP за каждый хранимый ресурс (до 3). Когда другой игрок объявляет ресурс, вы можете сохранить его или поменять местами с другим ресурсом на складе.",
    hooks: {
